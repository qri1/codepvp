...
(() => {
    ...
    const TASKS = [
        ...
        {
            tag: 'строки · регистр',
            body: 'Напишите solve(s): сделать первую букву каждого слова заглавной, остальные — строчными.',
        ...
        {
            tag: 'списки · бинарный поиск',
            body: 'Напишите solve(arr, x): по отсортированному массиву вернуть индекс x. Если нет — вернуть -1.',
            example: 'solve([1, 3, 5, 7, 9], 5) → 2',
            starter: 'def solve(arr, x):\n    return -1\n',
            tests: [
        ...
        {
            tag: 'списки · группировка',
            body: 'Напишите solve(arr): вернуть [сумма_чётных, сумма_нечётных].',
            example: 'solve([1, 2, 3, 4]) → [6, 4]',
            starter: 'def solve(arr):\n    return [0, 0]\n',
            tests: [
                { input: [[1, 2, 3, 4]],         expected: [6, 4] },
                { input: [[]],                   expected: [0, 0] },
                { input: [[2, 4, 6]],            expected: [12, 0] },
                { input: [[1, 3, 5]],            expected: [0, 9] },
                { input: [[10, 21, 32, 43]],     expected: [42, 64] },
            ],
        },
        {
            tag: 'строки · удаление',
            body: 'Напишите solve(s): удалить из строки все цифры.',
            example: 'solve("py3.11 fun4u") → "py. funu"',
            starter: 'def solve(s):\n    return s\n',
            tests: [
                { input: ['py3.11 fun4u'],       expected: 'py. funu' },
                { input: ['12345'],              expected: '' },
                { input: ['no digits here'],     expected: 'no digits here' },
                { input: [''],                   expected: '' },
        ...
        {
            tag: 'числа · степень',
            body: 'Напишите solve(a, n): вернуть a в степени n (n ≥ 0). Не используйте **.',
            example: 'solve(2, 10) → 1024',
            starter: 'def solve(a, n):\n    return 1\n',
            tests: [
        ...
        {
            tag: 'списки · среднее',
            body: 'Напишите solve(arr): вернуть среднее арифметическое чисел (число). Для пустого списка — 0.',
            example: 'solve([1, 2, 3, 4]) → 2.5',
            starter: 'def solve(arr):\n    return 0\n',
            tests: [
        ...
        {
            tag: 'строки · анаграммы',
            body: 'Напишите solve(a, b): вернуть True если строки a и b — анаграммы (одинаковый набор букв).',
            example: 'solve("листок", "столик") → True',
            starter: 'def solve(a, b):\n    return False\n',
            tests: [
                { input: ['листок', 'столик'],   expected: true },
                { input: ['hello', 'olelh'],     expected: true },
                { input: ['abc', 'abd'],         expected: false },
                { input: ['', ''],               expected: true },
                { input: ['abc', 'abcc'],        expected: false },
                { input: ['Listen', 'Silent'],   expected: false },
            ],
        },
        {
            tag: 'списки · перестановка',
            body: 'Напишите solve(arr): циклически сдвинуть массив вправо на 1 позицию.',
            example: 'solve([1, 2, 3, 4]) → [4, 1, 2, 3]',
            starter: 'def solve(arr):\n    return arr\n',
            tests: [
                { input: [[1, 2, 3, 4]],         expected: [4, 1, 2, 3] },
                { input: [[]],                   expected: [] },
                { input: [[1]],                  expected: [1] },
                { input: [[1, 2]],               expected: [2, 1] },
                { input: [[10, 20, 30]],         expected: [30, 10, 20] },
            ],
        },
        {
            tag: 'списки · агрегация',
            body: 'Напишите solve(arr): вернуть СПИСОК [минимум, максимум] или [None, None] для пустого списка.',
            example: 'solve([3, 1, 4, 1, 5]) → [1, 5]',
            starter: 'def solve(arr):\n    return [None, None]\n',
            tests: [
                { input: [[3, 1, 4, 1, 5]],      expected: [1, 5] },
                { input: [[42]],                 expected: [42, 42] },
                { input: [[]],                   expected: [null, null] },
                { input: [[-5, -10, 0, 5]],      expected: [-10, 5] },
